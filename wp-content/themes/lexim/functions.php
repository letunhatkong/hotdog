...
if ( ! function_exists( 'lexim_setup' ) ) :
	...
	function lexim_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'lexim_custom_background_args', array(
...
function lexim_scripts() {
	wp_enqueue_style( 'lexim-style', get_stylesheet_uri() );

	wp_enqueue_script( 'lexim-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'lexim-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
